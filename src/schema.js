export default {
  _id: "63156af147c4db5a1cd7dd01",
  type: "form",
  tags: [],
  owner: "5b55e8b41c8da0347428831a",
  revisions: "",
  _vid: 0,
  title: "Cook Chill`",
  display: "form",
  access: [
    {
      roles: [
        "62feb310db1fad7558564a25",
        "62feb310db1fad5ccd564a2a",
        "62feb310db1fad58bd564a2f",
      ],
      type: "read_all",
    },
  ],
  ...
  name: "cookChill",
  path: "cookchill",
  project: "62feb310db1fad642d564a1e",
  created: "2022-09-05T03:20:17.635Z",
  modified: "2022-09-06T01:09:54.543Z",
  machineName: "wphzyxbaupcldut:cookChill",
  components: [
    {
                  ...
                  components: [
                    {
                      ...
                      components: [
                        ...
                        },
                        {
                          ...
                          calculateValue:
                            "value = data.cookMethods1.trim().split('\\n')",
              ...
              columns: [
                {
                  components: [
                    ...
                    },
                    {
                      ...
                      calculateValue:
                        "value = data.chillMethods1.trim().split('\\n')",
                  ...
                  components: [
                    {
                      ...
                      key: "phase1Chill",
                      customConditional:
                        "show = data.chillSteps1 === 'onePhaseChill'",
                      type: "panel",
                      label: "Panel",
                      input: false,
                      tableView: false,
                  ...
                  components: [
                    {
                      ...
                      key: "phase1Chill1",
                      customConditional:
                        "show = data.chillSteps1 === 'twoPhaseChill'",
                      type: "panel",
                      label: "Panel",
                      input: false,
                      tableView: false,
              ...
              columns: [
                {
                  components: [
                    ...
                    },
                    {
                      ...
                      calculateValue:
                        "value = data.reThermMethods1.trim().split('\\n')",
                  ...
                  components: [
                    {
                      ...
                      components: [
                        ...
                        },
                        {
                          ...
                          calculateValue:
                            "value = data.reThermMethods2.trim().split('\\n')",
    ...
    {
      html: "<p><strong>End User</strong></p>",
      label: "Content",
      refreshOnChange: false,
      key: "content4",
      type: "content",
                  ...
                  components: [
                    {
                      ...
                      key: "product",
                      customConditional:
                        "show = data.productInput === 'freeText'",
                      type: "textfield",
                      input: true,
                    },
                    {
                      ...
                      key: "selectProduct",
                      customConditional:
                        "show = data.productInput === 'productDatabase'",
                      type: "select",
                      input: true,
                    },
                    {
                      ...
                      key: "assignedId",
                      customConditional:
                        "show = data.productOptions.assignUniqueId",
                      type: "textfield",
                      input: true,
                    },
                    {
              ...
              components: [
                {
                  ...
                  components: [
                    ...
                    },
                    {
                      ...
                      components: [
                        ...
                        },
                        {
                          ...
                          customConditional:
                            "show = data.productCategory === 'category1'",
                          type: "select",
                          input: true,
                        },
                        {
                          ...
                          logic: [
                            {
                              ...
                              trigger: {
                                type: "javascript",
                                javascript:
                                  "result = data.productCategory === 'category1' && data.productThickness",
                              },
                              actions: [
                                {
                                  name: "control value",
                    ...
                    },
                    {
                      ...
                      customConditional:
                        "show = data.cook === '6D Process (Listeria)'",
                      type: "well",
                      input: false,
                      tableView: false,
                      components: [
                        ...
                        },
                        {
                          ...
                          tableView: true,
                          calculateValue:
                            "value = data.internalProductTemperatureTime",
                    ...
                    },
                    {
                      ...
                      customConditional:
                        "show = data.cook === '6D Process (Clostridium)'",
                      type: "well",
                      input: false,
                      tableView: false,
                      components: [
                        ...
                        },
                        {
                          ...
                          tableView: true,
                          calculateValue:
                            "value = data.internalProductTemperature1Time",
                  ...
                  components: [
                    {
                      ...
                      key: "cookMethod1",
                      customConditional: "show = data.enable3",
                      logic: [
                        {
                          name: "get values",
                          trigger: {
                            type: "javascript",
                            javascript:
                              "result = data.cookMethods1Array.length",
                          },
                          actions: [
                            {
                              name: "get values",
                              type: "mergeComponentSchema",
                              schemaDefinition:
                                "let values = data.cookMethods1Array.map(item => {\n  if(!!item) {\n    return {\n      label: item,\n      value: item\n    }\n  } else {\n    return false\n  }\n})\n\nvalues = values.filter(value => value !== false)\nschema = { values }",
                            },
                          ],
                        },
                      ],
                    ...
                    },
                    {
                      ...
                      key: "chillMethod",
                      customConditional: "show = data.enable4",
                      logic: [
                        {
                          name: "get values",
                          trigger: {
                            type: "javascript",
                            javascript:
                              "result = data.chillMethods1Array.length",
                          },
                          actions: [
                            {
                              name: "get values",
                              type: "mergeComponentSchema",
                              schemaDefinition:
                                "let values = data.chillMethods1Array.map(item => {\n  if(!!item) {\n    return {\n      label: item,\n      value: item\n    }\n  } else {\n    return false\n  }\n})\n\nvalues = values.filter(value => value !== false)\nschema = { values }",
                            },
                          ],
                        },
                      ],
                  ...
                  components: [
                    {
                      ...
                      key: "reThermMethod",
                      customConditional: "show = data.enable5",
                      logic: [
                        {
                          name: "get values",
                          trigger: {
                            type: "javascript",
                            javascript:
                              "result = data.reThermMethods1Array.length",
                          },
                          actions: [
                            {
                              name: "get values",
                              type: "mergeComponentSchema",
                              schemaDefinition:
                                "let values = data.reThermMethods1Array.map(item => {\n  if(!!item){\n    return {\n      label: item,\n      value: item\n    }\n  } else {\n    return false\n  }\n})\n\nvalues = values.filter(value => value !== false)\nschema = { values }",
                            },
                          ],
                        },
                      ],
                  ...
                  components: [
                    {
                      ...
                      key: "serviceMethod",
                      customConditional: "show = data.enable52",
                      logic: [
                        {
                          name: "get values",
                          trigger: {
                            type: "javascript",
                            javascript:
                              "result = data.reThermMethods2Array.length",
                          },
                          actions: [
                            {
                              name: "get values",
                              type: "mergeComponentSchema",
                              schemaDefinition:
                                "let values = data.reThermMethods2Array.map(item => {\n  if(!!item) {\n    return {\n      label: item,\n      value: item\n    }\n  } else {\n    return false\n  }\n})\n\nvalues = values.filter(value => value !== false)\nschema = { values }",
                            },
                          ],
                        },
                      ],
              ...
              components: [
                {
                  ...
                  components: [
                          ...
                          actions: [
                            {
                              ...
                              type: "value",
                              value:
                                "const { productTemperature } = data.productTemperatureGrid.reduce((a, b) => {\n  if(a.productTemperature >= b.productTemperature) {\n    return a\n  } else {\n    return b\n  }\n})\n\nif(data.processSteps.Cook && typeof productTemperature === 'number') {\n  if(data.cook === 'Full Cook' && typeof data.criticalLimit === 'number') {\n    value = productTemperature > data.criticalLimit ? 'Pass' : 'Fail'\n  } else if(data.cook === 'Seal | Sear | Partial Cook' && typeof data.criticalLimit1 === 'number') {\n    value = productTemperature > data.criticalLimit1 ? 'Pass' : 'Fail'\n  } else {\n    value = null\n  }\n} else {\n  value = null\n}",
                            },
                          ],
                        },
                      ],
                    ...
                    },
                    {
                      ...
                      prefix: "Re-therm Status",
                      hideLabel: true,
                      disabled: true,
                      tableView: true,
                      calculateValue:
                        "const productTemperature = data.productTemperatureGrid[0].productTemperature\n\nif(data.processSteps['Re-therm'] && typeof productTemperature === 'number' && typeof data.criticalLimit2 === 'number') {\n  if(productTemperature > data.criticalLimit2) {\n    value = 'Pass'\n  } else {\n    value = 'Fail'\n  }\n} else {\n  value = null\n}",
                      key: "reThermStatus",
                      type: "textfield",
                      input: true,
                    },
                    {
                      ...
                      tableView: true,
                      calculateValue:
                        "const productTemperature = data.productTemperatureGrid[0].productTemperature\n\nif(data.processSteps.Service && typeof productTemperature === 'number' && typeof data.criticalLimit2113 === 'number') {\n  if(productTemperature > data.criticalLimit2113) {\n    value = 'Pass'\n  } else {\n    value = 'Fail'\n  }\n  \n} else {\n  value = null\n}",
                      key: "serviceStatus",
                      type: "textfield",
                      input: true,
                    },
              ...
              components: [
                {
                  ...
                  components: [
                    ...
                    },
                    {
                      ...
                      tableView: true,
                      calculateValue:
                        "value = data.processSteps.Cook ? data.cook : null",
                      key: "textField",
                      type: "textfield",
                      input: true,
                    },
                    {
                      ...
                      tableView: true,
                      calculateValue:
                        "if(data.cook === 'Sous Vide'){\n  value = data.timeRequired\n} else if(data.cook === '6D Process (Listeria)') {\n  value = data.cookTimeFor6DProcess\n} else if(data.cook === '6D Process (Clostridium)') {\n  value = data.cookTimeFor6DProcess1\n}",
                      key: "cookTime",
                      customConditional:
                        "show = data.cook === 'Sous Vide' || data.cook === '6D Process (Listeria)' || data.cook === '6D Process (Clostridium)' ",
                      type: "textfield",
                      input: true,
                    },
                    {
                      ...
                      tableView: true,
                      calculateValue:
                        "if(data.cook === 'Full Cook') {\n  value = data.criticalLimit\n} else if(data.cook === 'Seal | Sear | Partial Cook') {\n  value = data.criticalLimit1\n} else if(data.cook === 'Sous Vide') {\n  value = data.cookTemperature\n} else if(data.cook === '6D Process (Listeria)') {\n  value = data.internalProductTemperature\n} else if(data.cook === '6D Process (Clostridium)') {\n  value = data.internalProductTemperature1\n}",
                      key: "cookTemp",
                      type: "textfield",
                      input: true,
                    },
                ...
                },
                {
                  ...
                  components: [
                    ...
                    },
                    {
                      ...
                      tableView: true,
                      calculateValue:
                        "if(data.processSteps['Re-therm']) {\n  value = data.productTemperatureGrid[0].productTemperature\n} else {\n  value = null\n}",
                      key: "temperature1",
                      type: "textfield",
                      input: true,
                    },
              ...
              components: [
                {
                  ...
                  components: [
                    ...
                    },
                    {
                      ...
                      components: [
                        {
                          label: "Chill Time Phase 1",
                          prefix: "Chill Time Phase 1",
                          hideLabel: true,
                          disabled: true,
                          tableView: true,
                          key: "chillTimePhase1",
                    ...
                    },
                    {
                      ...
                      components: [
                        {
                          label: "Chill Time Phase 2",
                          prefix: "Chill Time Phase 2",
                          hideLabel: true,
                          disabled: true,
                          tableView: true,
                          key: "chillTimePhase2",
                        ...
                        },
                        {
                          ...
                          prefix: "Phase 2 Status",
                          hideLabel: true,
                          disabled: true,
                          tableView: true,
                          key: "chillPhase2Status",
                          type: "textfield",
                          input: true,
                        },
                      ],
                    ...
                    {
                      label: "Total Time Chilled",
                      prefix: "Total Time Chilled",
                      hideLabel: true,
                      disabled: true,
                      tableView: true,
                      key: "totalTimeChilled",
                      type: "textfield",
                      input: true,
                    },
                  ],
          ...
          components: [
            {
              ...
              components: [
                {
                  label: "Target Temp. Achieved",
                  prefix: "Target Temp. Achieved",
                  hideLabel: true,
                  disabled: true,
                  tableView: true,
                  calculateValue:
                    "if(data.processSteps.Cook) {\n  value = data.productTemperatureGrid[0].productTemperature\n} else {\n  value = null\n}",
                  key: "targetTempAchieved",
                  type: "textfield",
                  input: true,
                },
                {
                ...
                {
                  label: "Cook Time Passed",
                  prefix: "Cook Time Passed",
                  hideLabel: true,
                  disabled: true,
                  tableView: true,
                  key: "cookTimePassed",
                  customConditional: "show = data.time1.timePassed",
                  attributes: {
                ...
                {
                  label: "Cook Time Remaining",
                  prefix: "Cook Time Remaining",
                  hideLabel: true,
                  disabled: true,
                  tableView: true,
                  key: "cookTimePassed1",
                  customConditional: "show = data.time1.timeRemaining",
                  type: "textfield",
                  input: true,
                },
                {
              ...
              components: [
                {
                  ...
                  components: [
                    ...
                    {
                      label: "Chill Time Passed",
                      prefix: "Chill Time Passed",
                      hideLabel: true,
                      disabled: true,
                      tableView: true,
                      key: "chillTimePassed",
                    ...
                    {
                      label: "Chill Time Remaining",
                      prefix: "Chill Time Remaining",
                      hideLabel: true,
                      disabled: true,
                      tableView: true,
                      key: "chillTimePassed1",
    ...
    },
    {
      ...
      hideLabel: true,
      tableView: true,
      addAnother: "Add Product Temperature",
      saveRow: "Save Temperature",
      rowDrafts: false,
      key: "productTemperatureGrid",
      type: "editgrid",
